                    ...
                    <div class="col-md-12"> 
                        <div class="title-box text-center">
                            <div class="page-title-heading">
                                <h1 class="title">WordPress WooCommerce </h1>
                    ...
                    <div class="col-lg-9 content-area order-lg-2">
                        ...
                        <div class="ttm-service-single-content-area">
                            <div class="ttm_single_image-wrapper mb-35">
                                <img class="img-fluid" src="https://shehala.com/public/frontend/images/ecommarce.jpg" alt="single-img-twelve">
                            </div>
                            <div class="ttm-service-description">

                                <p>Shehala IT Limited expert dealing open source Joomla Ecommerce solutions interms of design, functionality and easy of use. We are expert integrating J2Store, VirtueMart, Quick2Cart, joocommerce and redSHOP with Joomla CMS.</p>
                                <p>The best part with joomla ecommerce is that we can integrate existing extensions or can create a new shopping cart for your solutions. We have expert of creating custom extensions for your need.</p>

                                <p>After integration or creating a new component for joomla ecommerce solution, we will make sure registration process is 100% perfect, design don’t break down or url are coming right way.</p>
                                ...
                                <h5>Services Shehala IT Limited offer for Joomla Ecommerce:</h5>
                                <p>
                                <ul>
                                <li><i class="fa fa-check-circle ttm-textcolor-skincolor"></i> Customized Ecommerce Development</li>
                                <li><i class="fa fa-check-circle ttm-textcolor-skincolor"></i> Integrate existing cart extensions</li>
                                <li><i class="fa fa-check-circle ttm-textcolor-skincolor"></i> Payment Getway Integration.</li>
                                <li><i class="fa fa-check-circle ttm-textcolor-skincolor"></i> Custom Module or Pluing development according to requirement on ecommerce.</li>
                                <li><i class="fa fa-check-circle ttm-textcolor-skincolor"></i> Maintenance</li>
                                <li><i class="fa fa-check-circle ttm-textcolor-skincolor"></i> Theme customization or development for ecommece store.</li>
                                <li><i class="fa fa-check-circle ttm-textcolor-skincolor"></i> SEO Optimization</li>
                                </ul>
