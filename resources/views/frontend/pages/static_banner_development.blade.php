                    ...
                    <div class="col-md-12"> 
                        <div class="title-box text-center">
                            <div class="page-title-heading">
                                <h1 class="title"> Static Banner Development</h1>
                ...
                <div class="row">
                    <div class="col-lg-9 content-area order-lg-2">
                        ...
                        <div class="ttm-service-single-content-area">
                            ...
                            <p>A rightly designed banner can trigger conversions, increase brand recall value and increase your chances of success online. Static banner development package consists of web banner(s) which are stationary in nature. There are ideal of placing on your own website or on websites you wish to advertise on.</p>
                            <p>Shehala IT Limited offers custom created banner ads that reflect your company’s image and can attract more customers for your business, all for a price that you can afford. We can provide you with a professionally designed and affordable web banner ad, our design team can help make your web advertising and web promotion work for you.</p>
                                ...
                                <h5>Why Choose Shehala IT Limited  Static Banner Development Services?</h5>
                                <ul>
                                <li><i class="fa fa-check-circle ttm-textcolor-skincolor"></i> Skilled and experienced banner designers</li>
                                <li><i class="fa fa-check-circle ttm-textcolor-skincolor"></i> Totally unique and creative banner designs</li>
                                <li><i class="fa fa-check-circle ttm-textcolor-skincolor"></i> Fast loading time</li>
                                <li><i class="fa fa-check-circle ttm-textcolor-skincolor"></i> Proper outlook to be most attractive</li>
                                <li><i class="fa fa-check-circle ttm-textcolor-skincolor"></i> Right size to be accepted in various browsers</li>
                                <li><i class="fa fa-check-circle ttm-textcolor-skincolor"></i> Available in all standard formats (.JPEG, .PSD, .GIF)</li>
                                <li><i class="fa fa-check-circle ttm-textcolor-skincolor"></i> 100% work satisfaction</li>
                                </ul>
                            </div>
                        </div>
