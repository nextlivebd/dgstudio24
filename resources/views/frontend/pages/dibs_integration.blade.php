                    ...
                    <div class="col-md-12"> 
                        <div class="title-box text-center">
                            <div class="page-title-heading">
                                <h1 class="title"> DIBS Integration</h1>
                ...
                <div class="row">
                    <div class="col-lg-9 content-area order-lg-2">
                        ...
                        <div class="ttm_single_image-wrapper mb-35">
                            ...
                            <p>Shehala IT Limited offer DIBS integration into your site with option of Hosted payment window, Server-to-server API, Webshop modules and DIBS Bulk Service API. We make sure request send to DIBS and Receive response from DIBS are 100% accurate, so that no error/bug occur interms of checkout.</p>
                           
                            <p>We also offer Card transaction integration in DIBS into your SSL site.</p>
