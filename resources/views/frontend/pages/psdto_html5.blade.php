                    ...
                    <div class="col-md-12"> 
                        <div class="title-box text-center">
                            <div class="page-title-heading">
                                <h1 class="title"> PSD To HTML5/BOOTSTRAP 4</h1>
                ...
                <div class="row">
                    <div class="col-lg-9 content-area order-lg-2">
                        ...
                        <div class="ttm-service-single-content-area">
                           ...
                           <p>Get a responsive & SEO friendly xhtml theme supported your site, we tend to deliver 100% hand-coded, responsive, cross-browser compatible and pixel-perfect. We meet your intensive PSD to xhtml & custom xhtml web development needs with our unbeatable quality xhtml services.</p>
                                ...
                                <li><i class="fa fa-check-circle ttm-textcolor-skincolor"></i> High Quality Markup</li>
                                <li><i class="fa fa-check-circle ttm-textcolor-skincolor"></i> PSD, Ai, Png Conversion Available</li>
                                <li><i class="fa fa-check-circle ttm-textcolor-skincolor"></i> Cross Browse Compatibility</li>
                                <li><i class="fa fa-check-circle ttm-textcolor-skincolor"></i> Pixel Perfect Conversion</li>
                                <li><i class="fa fa-check-circle ttm-textcolor-skincolor"></i> W3C Validated Markup</li>
                                <li><i class="fa fa-check-circle ttm-textcolor-skincolor"></i> SEO-friendly Code</li>
                                <li><i class="fa fa-check-circle ttm-textcolor-skincolor"></i> Performance Optimized</li>
                                <li><i class="fa fa-check-circle ttm-textcolor-skincolor"></i> Jquery Implementation</li>
                                <li><i class="fa fa-check-circle ttm-textcolor-skincolor"></i> Page speed Optimization</li>
                                <li><i class="fa fa-check-circle ttm-textcolor-skincolor"></i> 24×6 Customer Support</li>
