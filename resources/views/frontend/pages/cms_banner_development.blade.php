                    ...
                    <div class="col-md-12"> 
                        <div class="title-box text-center">
                            <div class="page-title-heading">
                                <h1 class="title"> CMS Banner Development</h1>
                ...
                <div class="row">
                    <div class="col-lg-9 content-area order-lg-2">
                        ...
                        <div class="ttm-service-single-content-area">
                            ...
                            <p>The built-in Banner Management module enables you to create, manage and display dynamic content on your website in the form of static and rotating banners via an easy-to-use backend.</p>
                            <p>Shehala IT Limited offers high impacting and effective CMS banner development that helps you in getting maximum response for your online advertisement campaign. All of our CMS banners are custom designed, uniquely, & created innovatively to suit your needs. CMS Banners are latest way to grab the attention of potential customers.</p>
                            <p>Shehala IT Limited process a great creative instinct, design capabilities, depth of expertise and unmatched resources that allow them to provide an extraordinary CMS banner design services. We used latest technology- HTML5, CSS3, JS, Cake PHP and DOM.</p>
