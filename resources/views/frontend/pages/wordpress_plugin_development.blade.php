                    ...
                    <div class="col-md-12"> 
                        <div class="title-box text-center">
                            <div class="page-title-heading">
                                <h1 class="title"> Wordpress Plugin Development</h1>
                    ...
                    <div class="col-lg-9 content-area order-lg-2">
                        ...
                        <div class="ttm-service-single-content-area">
                            ...
                            <div class="row no-gutters box-shadow mb-35">
                                ...
                                <ul>
                                <li><i class="fa fa-check-circle ttm-textcolor-skincolor"></i> WP Plugin Development</li>
                                <li><i class="fa fa-check-circle ttm-textcolor-skincolor"></i> WP Plugin Installation</li>
                                <li><i class="fa fa-check-circle ttm-textcolor-skincolor"></i> WP Plugin Customization</li>
                                <li><i class="fa fa-check-circle ttm-textcolor-skincolor"></i> WP Plugin Integration</li>
                                <li><i class="fa fa-check-circle ttm-textcolor-skincolor"></i> WP Plugin Upgrades</li>
                                </ul><br/>
                                ...
                                <ul>
                                <li><i class="fa fa-check-circle ttm-textcolor-skincolor"></i> We handle all improvements to our Custom Plugins, nevertheless of the theme you choose</li>
                                <li><i class="fa fa-check-circle ttm-textcolor-skincolor"></i> Our Plugins are carefully designed with future changes & updates in mind</li>
                                <li><i class="fa fa-check-circle ttm-textcolor-skincolor"></i> We promise our custom WordPress Plugins will never leave your site or information weak to hackers or identity thieves</li>
                                <li><i class="fa fa-check-circle ttm-textcolor-skincolor"></i> 24/6 Customer & Technical Support available by Chat & Email</li>
                                </ul><br/>
