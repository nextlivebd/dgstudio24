                    ...
                    <div class="col-md-12"> 
                        <div class="title-box text-center">
                            <div class="page-title-heading">
                                <h1 class="title"> Paypal Integration</h1>
                            ...
                            <div class="breadcrumb-wrapper">
                                ...
                                <span> Payment Getway Solutions</span>
                            </div>  
                        </div>
                    </div><!-- /.col-md-12 -->  
                </div><!-- /.row -->  
                ...
                <div class="row">
                    <div class="col-lg-9 content-area order-lg-2">
                        ...
                        <div class="ttm_single_image-wrapper mb-35">
                            <img class="img-fluid" src="https://shehala.com/public/frontend/images/payment.jpg" alt="single-img-twelve">
                            </div>
                            <div class="ttm-service-description">
                            <p>We Shehala IT Limited offer paypal integration to your Custom Coded Site and CMS. Paypal integration is not limited to form based integration, we also offer Express Checkout with IPN, so that order status can be trace after payment is confirm.</p>
                           
                           <h5>We offer:</h5><br/>
                           <ul>
                                <li><i class="fa fa-check-circle ttm-textcolor-skincolor"></i> Basic client integration</li>
                                <li><i class="fa fa-check-circle ttm-textcolor-skincolor"></i> Advanced server integration</li>
