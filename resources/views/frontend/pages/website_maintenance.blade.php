                    ...
                    <div class="col-lg-9 content-area order-lg-2">
                        ...
                        <div class="ttm-service-single-content-area">
                            ...
                            <div class="ttm-service-description">
                                ...
                                <p>Shehala IT Limited can help you preserve your website investment by putting together a website maintenance services plan to keep your website secure, online and up to date. One of the most vital parts of owning and operating a website is maintaining it on a practical basis. Don’t wait until it is several versions behind, has been hacked or slowed to a crawl, we can keep your site running well, now and into the future.</p>
                                ...
                                <h5> Shehala IT Limited website maintenance service plans focus on these key areas:</h5>
                                <p>

                                <ul>
                                <li><i class="fa fa-check-circle ttm-textcolor-skincolor"></i> Real time security</li>
                                <li><i class="fa fa-check-circle ttm-textcolor-skincolor"></i> Malware and hack detection with immediate cleanup</li>
                                <li><i class="fa fa-check-circle ttm-textcolor-skincolor"></i> Backups, Lots of backups</li>
                                <li><i class="fa fa-check-circle ttm-textcolor-skincolor"></i> Regular Software updates (core, themes and plugins)</li>
                                <li><i class="fa fa-check-circle ttm-textcolor-skincolor"></i> Website performance &amp; uptime monitoring</li>
                                <li><i class="fa fa-check-circle ttm-textcolor-skincolor"></i> On-call web support / webmaster services when you need it</li>
                                </ul>

                                </p>
                             
                                <p>Shehala IT Limited Web Support provides client-service focused website maintenance services. With over 50 individual sites that we are responsible for and several folks that have well over 8 years’ experience in Web Development, we consider ourselves experts from trouble shooting quickly and efficiently to helping you plan your next new feature; we are consultants, developers and client support specialists.</p>
