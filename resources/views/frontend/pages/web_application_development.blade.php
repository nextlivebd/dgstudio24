                        ...
                        <div class="ttm-service-single-content-area">
                            ...
                            <div class="ttm-service-description">
                               <h5>Iphone and Android Application:</h5>
                                ...
                                <p>
                                With Classic Race Aarhus app you all the time is updated in relation to the latest news, maps, program, race program, drivers, live results, tickets, sponsors, videos, photo gallery and much else that moves in connection with the Classic Race Aarhus. If you have with this app so all the information you need in connection with the Classic Race Aarhus, allowing you to easily and quickly in connection with the race can keep up – either from the sidelines when the cars whiz past, or if you just want to be updated.</p>
                                <h5>Online Christmas Calendar System:</h5>
                                <p>During all the Christmas day starting with December 1 the client will get the opportunity to insert questions, sponsors as well as choosing winners for the Interactive Christmas Quiz calendar.</p>

                                <h5>File Manager Desktop Application:</h5>
                                <p>Description: Managing, Uploading, Downloading, Checking and Deleting Print Ready PDF for the group of Agencies and Customers. It makes easy while there is an option for chatting/commenting on each files and see the output live.</p>

                                <h5>HTML5 Banner with Dynamic Backend:</h5>
                                <p>Banner items can be changed dynamically from the backend by the backend users/clients. There are also options to see the click counts on every banners.</p>

                                <h5>Online system for ordering the banners:</h5>
                                <p>Through this online ordering system the banner clients can send banner jobs directly, they can even check the status, change the banner animations if necessary etc.</p>
                                
                                <h5>Catalog conversion system to flipbook:</h5>
                                <p>Online catalog conversion from PDF to interactive Flipbook format.</p>

                                <h5>Mobile and Desktop Games:</h5>
                                <p>We have developed several games both for mobile and desktop platform. The mobile games in the app store and google play are: Fly Copter, Tennis Juggle and for the desktop platform the game names are – Co2 Connie(Shooting)</p>
