                    ...
                    <div class="col-md-12"> 
                        <div class="title-box text-center">
                            <div class="page-title-heading">
                                <h1 class="title"> Flash Banner Development</h1>
                    ...
                    <div class="col-lg-9 content-area order-lg-2">
                        ...
                        <div class="ttm-service-single-content-area">
                            <div class="ttm_single_image-wrapper mb-35">
                                <!-- <img class="img-fluid" src="https://shehala.com/public/frontend/images/Responsive-Design-1.jpg" alt="single-img-twelve"> -->
                            </div>
                            <div class="ttm-service-description">

                            <p>Shehala IT Limited offers effective Flash Banner Development that helps you in getting maximum response for your online advertisement campaign. Our flash banners are designed uniquely & created innovatively to suit your needs. Flash Banners are latest way to grab the attention of potential customers.</p>
                            <p>Shehala IT Limited process a great creative instinct, design capabilities, depth of expertise and unmatched resources that allow them to provide an extraordinary flash banner design services. We offer complete banner design services through an instinctive and disciplined approach.</p>
                                ...
                                <h5>Key Features of Flash Banner Development:</h5>
                                <ul>
                                <li><i class="fa fa-check-circle ttm-textcolor-skincolor"></i> Complete Concept Design</li>
                                <li><i class="fa fa-check-circle ttm-textcolor-skincolor"></i> Clicktag Implementation</li>
                                <li><i class="fa fa-check-circle ttm-textcolor-skincolor"></i> Flash Programming & Animation</li>
                                <li><i class="fa fa-check-circle ttm-textcolor-skincolor"></i> Banner Resizing</li>
                                <li><i class="fa fa-check-circle ttm-textcolor-skincolor"></i> Action Script Game & Apps Development</li>
                                </ul><br/>

                                <h5>Benefit of Flash Banner Design:</h5>
                                <ul>

                                <li><i class="fa fa-check-circle ttm-textcolor-skincolor"></i> You can visually deliver your message with a powerful impact by using eye-catching graphics to create an overall attractive banner.</li>
                                <li><i class="fa fa-check-circle ttm-textcolor-skincolor"></i> The attractive banner can increase the conversion ratio of your site visits which would ultimately lead to higher ROI.</li>
                                </ul>

                                <p>Flash banners help you connect your company’s goal more effectively and many more</p>
                            </div>
                        </div>
