...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="h3 mb-0 text-gray-800">Add New Tab</h2>
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            <form action="{{ route('admin.home-different.tabs.store') }}" method="POST">
                @csrf

                <div class="row">
                    <div class="col-md-6 mb-3">
                        <label for="title" class="form-label">Tab Title / Label</label>
                        <input type="text" class="form-control" id="title" name="title" value="{{ old('title') }}" placeholder="e.g. Reduce your costs" required>
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="input-group">
                            <span class="input-group-text icon-preview-box">
                                <i id="icon-preview" class="flaticon flaticon-code"></i>
                            </span>
                            <input type="text" class="form-control" id="icon" name="icon" value="{{ old('icon', 'flaticon-code') }}" placeholder="e.g. flaticon-code">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="content_title" name="content_title" value="{{ old('content_title') }}" placeholder="e.g. Reduce your project costs">
                </div>

                <div class="mb-3">
                    <label for="content_description" class="form-label">Tab Content Description</label>
                    <textarea class="form-control" id="content_description" name="content_description" rows="5" placeholder="Enter content detailed text description...">{{ old('content_description') }}</textarea>
                </div>
                ...
                <button type="submit" class="btn btn-primary">
                    <i class="fas fa-save"></i> Save Tab
                </button>
            </form>
        </div>
    </div>
