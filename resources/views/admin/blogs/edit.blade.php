...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="h3 mb-0 text-gray-800">Edit Blog</h2>
    ...
    <form action="{{ route('admin.blogs.update', $blog->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="row">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="meta_keywords" name="meta_keywords" value="{{ old('meta_keywords', $blog->meta_keywords) }}" placeholder="e.g. blog, tech, news">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="status" name="status" required>
                                ...
                                <option value="unpublished" {{ (old('status') ?? $blog->status) == 'unpublished' ? 'selected' : '' }}>Unpublished</option>
                            </select>
                        </div>
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            @if($blog->thumbnail)
                                <div class="mb-2">
                                    <img src="{{ asset('storage/' . $blog->thumbnail) }}" alt="Current Thumbnail" class="img-thumbnail" style="max-height: 150px;">
                                </div>
                            @endif
                ...
                <button type="submit" class="btn btn-primary w-100 btn-lg shadow-sm">Update Blog Post</button>
            </div>
        </div>
    </form>
</div>
