...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="h3 mb-0 text-gray-800">Edit Portfolio</h2>
                ...
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="summernote" name="description" rows="10">{{ old('description', $portfolio->description) }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="project_date" name="project_date" value="{{ old('project_date', $portfolio->project_date) }}">
                        </div>

                        <div class="mb-3">
                            <label for="website_url" class="form-label">Website URL</label>
                            <input type="text" class="form-control" id="website_url" name="website_url" value="{{ old('website_url', $portfolio->website_url) }}">
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            @if($portfolio->image)
                                <div class="mb-2">
                                    <img src="{{ asset($portfolio->image) }}" alt="{{ $portfolio->title }}" class="img-thumbnail" style="max-height: 150px;">
                                </div>
                            @endif
                        ...
                        <button type="submit" class="btn btn-primary w-100 mt-3">Update Portfolio</button>
                    </div>
                </div>
            </form>
        </div>
