        ...
        <div class="card-body">
            <form action="{{ route('admin.pages.store') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="slug" name="slug" value="{{ old('slug') }}" placeholder="e.g. custom-page-slug" required>
                    <small class="text-muted">The URL slug determines the page path. Must be lowercase alphanumeric format with hyphens only (e.g. <code>my-new-page</code>).</small>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea id="summernote" name="content" class="form-control" rows="15">{{ old('content') }}</textarea>
                </div>
