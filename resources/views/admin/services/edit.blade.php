                ...
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="summernote" name="description" rows="10">{{ old('description', $service->description) }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="mb-3">
                            ...
                            @if($service->thumbnail_image)
                                <div class="mb-2">
                                    <img src="{{ asset($service->thumbnail_image) }}" alt="{{ $service->title }}" class="img-thumbnail" style="max-height: 150px;">
                                </div>
                            @endif
