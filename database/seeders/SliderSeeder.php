...
class SliderSeeder extends Seeder
{
    ...
    public function run(): void
    {
        Slider::firstOrCreate(
            ['title_1' => 'We Create Beautiful', 'order' => 1],
            [
        ...
        Slider::firstOrCreate(
            ['title_1' => 'Best<strong class="ttm-textcolor-skincolor"> Quality Web Application </strong>', 'order' => 2],
            [
        ...
        Slider::firstOrCreate(
            ['title_1' => 'We Create Beautiful', 'order' => 3],
            [
                'background_image' => 'frontend/images/slides/slider-mainbg-003.jpg',
