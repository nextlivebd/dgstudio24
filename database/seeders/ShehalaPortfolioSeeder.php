...
class ShehalaPortfolioSeeder extends Seeder
{
    public function run()
    {
        ...
        $items = [
            ...
            ["category" => "WordPress", "title" => "Arhus Handbold", "image" => "https://shehala.com/images/portfolio-images/YhDqWp6qU5s5b0K3L7A2.png", "website_url" => "https://shehala.com/portfolio-details/6/1"],
            ...
            ["category" => "Joomla", "title" => "Alt om Handarbejde", "image" => "https://shehala.com/images/portfolio-images/afewzMeooebg9nX3IVXZ.jpg", "website_url" => "https://shehala.com/portfolio-details/13/2"],
            ...
            ["category" => "Joomla", "title" => "Alt om Handarbeide Norwegian", "image" => "https://shehala.com/images/portfolio-images/LZ8huqzTiuS14CncW7GU.jpg", "website_url" => "https://shehala.com/portfolio-details/15/2"],
